...
class InlineFormatter(editor: AztecText, val codeStyle: CodeStyle) : AztecFormatter(editor) {
    ...
    fun makeInlineSpan(textFormat: ITextFormat): IAztecInlineSpan {
        when (textFormat) {
            ...
            AztecTextFormat.FORMAT_COLOR -> return AztecColorSpan(spanColor ?: R.color.fg_black)
            AztecTextFormat.FORMAT_BACKGROUND -> return AztecBackgroundColorSpan(backgroundSpanColor ?: R.color.bg_none)
